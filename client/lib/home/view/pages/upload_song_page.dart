...
class _UploadSongPageState extends ConsumerState<UploadSongPage> {
  ...
  Widget build(BuildContext context) {
    final homeLoading = ref.watch(homeViewModelProvider)?.isLoading ?? false;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () async {
                // for testing on clicking it lead to homeRepository class
                // to upload song data on cloudinary
